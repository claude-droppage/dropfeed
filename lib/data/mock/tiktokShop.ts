...
const US: TikTokShopItem[] = [
  { id: "mock-1", rank: 1, name: '40oz Insulated Tumbler', emoji: '🥤', sold: '14,2 tys.', trend: '▲ 32%' },
  { id: "mock-2", rank: 2, name: 'LED Face Mask Therapy', emoji: '💡', sold: '8,7 tys.', trend: '▲ 18%' },
  { id: "mock-3", rank: 3, name: 'Mini Waffle Maker', emoji: '🧇', sold: '6,1 tys.', trend: '▲ 9%' },
  { id: "mock-4", rank: 4, name: 'Hair Growth Serum', emoji: '🧴', sold: '5,4 tys.', trend: '▲ 21%' },
  { id: "mock-5", rank: 5, name: 'Compression Socks 3-pack', emoji: '🧦', sold: '4,8 tys.', trend: '▲ 6%' },
]

const PL_FIRST_MOVES: TikTokShopItem[] = [
  { id: "mock-6", rank: 1, name: 'beBIO Cosmetics — krem', emoji: '🧴', sold: '312', trend: 'nowy' },
  { id: "mock-7", rank: 2, name: 'Carpatree — legginsy', emoji: '💪', sold: '204', trend: 'nowy' },
]
