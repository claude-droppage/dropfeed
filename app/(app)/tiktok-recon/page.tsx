    ...
    <div className="h-full overflow-y-auto bg-bg-void">
      <div className="mx-auto max-w-2xl px-5 pt-8 pb-20">
        ...
        <p className="text-text-lo text-xs mb-4">
          Realne reklamy z biblioteki TikTok (EU). Dane = to, co faktycznie dostajemy z jednego scrape. Klik w kreację
          otwiera <span className="text-text-mid">stronę reklamy w bibliotece TikToka</span>. „Szukaj na TikToku" =
          wyszukiwarka po nazwie reklamodawcy (profilu/fanpage nie ma w danych — tylko nazwa). Linku do sklepu/produktu
          scrape nie zwraca.
        </p>
